	...
	<?php
		...
		try {
			...
			if($st->rowCount()==0) {
				...
				<div class="center" style="font-size:120%; padding-bottom:200px;"><?php echo "Aucun affectation trouvée dans la base de donnée.";?></div><?php
			} else {
				?>
				<div class="table-custom" style="width:80%;margin-left:10%; margin-bottom:100px;">
					<h2>Liste des affectations pour suppression</h2>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">
														<p style="color:black;">Voulez-vous vraiment supprimer le tuteur du stage ?</p>
													</div>
													<div class="modal-footer center">
														<form action="suppr_affectation.php" method="post">
